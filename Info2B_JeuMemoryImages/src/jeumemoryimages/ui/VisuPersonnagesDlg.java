    ...
    private void ShowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ShowActionPerformed
        ...
        if(nbCharacter>0){
            ...
            for(int x=0;x<nbButton;x++){
                PanneauImage currentP = (PanneauImage) jPanelTrombi.getComponent(x);
                currentP.setImage(characterList.getPerso(x).getPhoto());
            }    
        }
    ...
    private void initPanneau(){
        ...
        if(nbCharacter>0){
            ...
            for(int x=0;x<nbCharacter;x++){
                ...
                panneauImage.setPreferredSize(new Dimension(anonymIcon.getIconWidth(),anonymIcon.getIconHeight())); // on définit la taille du boutton a partir de la taille de l'image d'anonyme
                jPanelTrombi.add(panneauImage);
            }
