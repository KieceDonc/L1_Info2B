...
import jeumemoryimages.Bataille;
...
public class BatailleDlg extends javax.swing.JDialog {
    ...
    */
    ...
    private void initComponents() {
        ...
        Carte1 = new BoutonImage();
        Carte2 = new BoutonImage();
        ...
        if(adversaire!=null){
            if(canStart){
                ...
                if(batailleResult==1||batailleResult==2){
                    ...
                    updateCartes(joueur.getEnPossession().toString()+"\n",adversaire.getEnPossession().toString()+"\n");
                    Carte1.setImage(joueur.getEnPossession().getPerso(0).getPhoto()); // on affiche la photo de la nouvelle carte au dessus du paquet
                    Carte2.setImage(adversaire.getEnPossession().getPerso(0).getPhoto()); // on affiche la photo de la nouvelle carte au dessus du paquet
    ...
    private BoutonImage Carte1;
    private BoutonImage Carte2;
